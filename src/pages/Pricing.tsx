          ...
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="max-w-2xl mx-auto space-y-3 text-base">
              <p className="text-foreground">
                <strong>Reserva directa:</strong> Detalle de bienvenida y salida tardía incluidos
              </p>
              <p className="text-foreground">
                <strong>Oferta de larga estancia:</strong> Descuentos especiales para estancias prolongadas
              </p>
            </div>
          </div>
        </section>
